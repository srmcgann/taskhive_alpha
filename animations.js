function init(){
	...
	v[0].c.style.height=(document.getElementsByClassName("header9")[0].clientHeight/3)+"px";
	...
	window.addEventListener("resize", function resize(){
		...
		v[0].c.width = v[0].c.clientWidth;
		v[0].c.height = v[0].c.clientHeight;
		v[1].c.style.height=document.getElementsByClassName("header2")[0].clientHeight+"px";
		v[1].vx=document.getElementsByClassName("header2")[0].clientWidth/951.5;
		v[1].vy=document.getElementsByClassName("header2")[0].clientHeight/567*1.42;
	...
	v[1].c.height = v[1].c.clientHeight;
	v[1].vx=document.getElementsByClassName("header2")[0].clientWidth/951.5;
	v[1].vy=document.getElementsByClassName("header2")[0].clientHeight/567;
	v[1].c.style.height=document.getElementsByClassName("header2")[0].clientHeight+"px";
	startStopAnimations();
}
